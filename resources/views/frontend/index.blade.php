...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('themes/charity/css/templatemo-kind-heart-charity.css') }}" rel="stylesheet">
<!--
        ...
        <nav class="navbar navbar-expand-lg bg-light shadow-lg">
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('themes/charity/images/logo.png') }}" class="logo img-fluid" alt="Kind Heart Charity">
                    <span>
                        Kind Heart Charity
                            ...
                            <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('themes/charity/images/slide/volunteer-helping-with-donation-box.jpg') }}" class="carousel-image img-fluid" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ asset('themes/charity/images/slide/volunteer-selecting-organizing-clothes-donations-charity.jpg') }}" class="carousel-image img-fluid" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ asset('themes/charity/images/slide/medium-shot-people-collecting-donations.jpg') }}" class="carousel-image img-fluid" alt="...">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="{{ asset('themes/charity/images/icons/hands.png') }}" class="featured-block-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="{{ asset('themes/charity/images/icons/heart.png') }}" class="featured-block-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="{{ asset('themes/charity/images/icons/receive.png') }}" class="featured-block-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="donate.html" class="d-block">
                                    <img src="{{ asset('themes/charity/images/icons/scholarship.png') }}" class="featured-block-image img-fluid" alt="">
