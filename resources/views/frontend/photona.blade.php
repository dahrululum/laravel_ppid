                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="text-white">Gallery Photo :: {{ $page->title }}</h2>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="news-block">
                                @if(!empty($page->foto_utama))
                                <div class="news-block-top mb-3">
                                    <img src="{{ asset('uploads/'.$page->foto_utama) }}" class="news-image img-fluid" alt="">
