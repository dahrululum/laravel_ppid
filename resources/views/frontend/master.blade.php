...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{url('themes/mexant/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="{{url('themes/mexant/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{url('themes/mexant/assets/css/templatemo-574-mexant.css') }}">
    <link rel="stylesheet" href="{{url('themes/mexant/assets/css/owl.css') }}">
    <link rel="stylesheet" href="{{url('themes/mexant/assets/css/animate.css') }}">
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="index.html" class="logo">
                          <img src="{{url('themes/mexant/assets/images/logo.png') }}" alt="">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
  ...
  <div class="swiper-container" id="top">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url({{url('themes/mexant/assets/images/slide-01.jpg') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url({{url('themes/mexant/assets/images/slide-02.jpg') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url({{url('themes/mexant/assets/images/slide-03.jpg') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
...
@yield('footer')
  ...
  <!-- Bootstrap core JavaScript -->
    <script src="{{url('themes/mexant/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{url('themes/mexant/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <script src="{{url('themes/mexant/assets/js/isotope.min.js') }}"></script>
    <script src="{{url('themes/mexant/assets/js/owl-carousel.js') }}"></script>

    <script src="{{url('themes/mexant/assets/js/tabs.js') }}"></script>
    <script src="{{url('themes/mexant/assets/js/swiper.js') }}"></script>
    <script src="{{url('themes/mexant/assets/js/custom.js') }}"></script>
    <script>
