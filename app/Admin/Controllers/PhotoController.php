...
class PhotoController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        // $grid->column('introtext', __('Introtext'))->limit(30);
      
         $grid->column('foto_utama', __('Featured Foto'))->image();
    ...
    protected function detail($id)
    {
        ...
        $show->field('foto_utama', __('Foto utama'))->image();
        $show->field('fotos', __('Gallery Photo'))->carousel();
    ...
    protected function form()
    {
        ...
        $form->image('foto_utama', __('Foto Utama'))->move('photos')->uniqueName()->help('ukuran file max: 2MB, format: jpg, png, jpeg')->setWidth(6, 2);
        $form->multipleImage('fotos', 'Foto Lainnya')->move('photos')->uniqueName()->help('ukuran file max: 2MB, format: jpg, png, jpeg')->setWidth(6, 2);
